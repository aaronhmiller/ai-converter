...
# --- SMART DOC LOADING BASED ON DOCKERFILE ---
import re
...
def main():
    ...
    print("Usage: python rag_ollama_chainguard.py /path/to/Dockerfile\n")
    if len(sys.argv) != 2:
        print("Error: Please provide the path to a Dockerfile as an argument.")
        sys.exit(1)
